                ...
                <div class="row">
                  ...
                  <div class="col-7 col-stats">
                    <div class="numbers">
                      ...
                      <h4 class="card-title"><?php echo $this->M_perpus->edit_data(array('status_peminjaman'=>0),'transaksi')->num_rows(); ?></h4>
                      <a style="color: #fff; text-decoration: none;" href="http://localhost/perpust3/admin/peminjaman"> Details <i style="margin-left: 10px;" class="fas fa-long-arrow-alt-right"></i></a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-stats">
                    <div class="numbers">
                      ...
                      <h4 class="card-title"><?php echo $this->M_perpus->edit_data(array('status_peminjaman'=>1),'transaksi')->num_rows(); ?></h4>
